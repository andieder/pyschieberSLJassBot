...
from sljassbot.player.sl_player.one_three_three_eight.input_handler import InputHandler, card_to_index, index_to_card
from sljassbot.player.sl_player.one_three_three_eight.model import build_model

logger = logging.getLogger(__name__)


class SLPlayer1338(BasePlayer):
    max_points = 55
    min_points = -55
