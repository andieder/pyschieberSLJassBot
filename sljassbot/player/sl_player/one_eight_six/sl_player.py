...
from sljassbot.player.sl_player.one_eight_six.input_handler import InputHandler, card_to_index, index_to_card
from sljassbot.player.sl_player.one_eight_six.model import build_model

logger = logging.getLogger(__name__)


class SLPlayer186(BasePlayer):
    max_points = 55
    min_points = -55
