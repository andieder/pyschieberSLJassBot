...
from sljassbot.player.sl_player.two_two_two.input_handler import InputHandler, card_to_index, index_to_card
from sljassbot.player.sl_player.two_two_two.model import build_model

logger = logging.getLogger(__name__)


class SLPlayer222(BasePlayer):
    max_points = 55
    min_points = -55
